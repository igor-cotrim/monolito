...
describe("#place_order_usecase_unit_test", () => {
  describe("#validate_products_method", () => {
  ...
  describe("#get_products_method", () => {
    ...
    it("should throw an error when product not found", async () => {
      ...
      await expect(placeOrderUseCase["getProduct"]("1")).rejects.toThrow(
